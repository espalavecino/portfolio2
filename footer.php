    ...
    <div class="container">
        <div class="row py-5">
            ...
            <div class="col-sm-4 col-12 text-center py-4 py-sm-0">
                ...
                <a href="https://www.linkedin.com/in/esteban-palavecino-06354a120/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                <a href="https://github.com/espalavecino" target="_blank"><i class="fab fa-github"></i></a>
            </div>
